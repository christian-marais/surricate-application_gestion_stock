            ...
            <div class='row form_liste' >
               <table class="table">
                  ...
                  <tbody class="table_body">
                     <tr>
                        <td class=""><input placeholder="ID de 50 caractères maximum" maxlength="50" class="form_control" name="id_centre"/></td>
                        <td class=""><input placeholder="Nom du centre" class="form_control"  name="nom_centre"/></td>
                     ...
                     <?php foreach($datas as $data):?>
                        <tr>
                           <td>
                              <input class="form_control" name="<?='id_centre'.$data['id_centre']?>" value="<?=$data['id_centre']?>">
                           </td>
                           <td>
                              <input class="form_control" name="<?='nom_centre'.$data['id_centre']?>" value="<?=$data['nom_centre']?>">
                           </td>
                           <td class="form_content_button action_button">
                                 <input type='text' name="<?=$data['id_centre']?>" value="<?=$data['nom_centre']?>" class="hidden"/>
                                 <button type="submit" name="validating_edit" value="<?=$data['id_centre']?>"class="edit_groupe"><i class="uil uil-pen"></i>Editer</button>
                                 <button type="submit" name="delete" value="<?=$data['id_centre']?>" class="delete_groupe button danger"><i class="uil uil-trash-alt"></i>Supprimer</button>
                           </td>
                        </tr>
                     <?php endforeach;?>
                  </tbody>
